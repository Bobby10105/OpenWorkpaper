              ...
              <div key={workload.name} className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:border-indigo-200 transition-all group">
                ...
                <div className="flex items-center space-x-6">
                  <div className="space-y-1">
                    <p suppressHydrationWarning className="text-[10px] font-bold text-indigo-600 uppercase tracking-tighter">Assigned</p>
                    <p className="text-xl font-black text-slate-900 leading-none">{workload.pending}</p>
                  </div>
                  <div className="h-8 w-px bg-slate-100" />
                  <div className="space-y-1">
                    <p suppressHydrationWarning className="text-[10px] font-bold text-emerald-600 uppercase tracking-tighter">Prepared</p>
                    <p className="text-xl font-black text-slate-900 leading-none">{workload.awaitingReview}</p>
                  </div>
                  <div className="h-8 w-px bg-slate-100" />
                  <div className="space-y-1">
                    <p suppressHydrationWarning className="text-[10px] font-bold text-blue-600 uppercase tracking-tighter">Reviewed</p>
